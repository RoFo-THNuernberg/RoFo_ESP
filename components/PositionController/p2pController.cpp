...
p2pController::p2pController(float kp_v, float kp_w, ros_msgs::Point2D const& goal_point) : _kp_v{kp_v}, _kp_w{kp_w}, _goal_point{goal_point} {}

ros_msgs::Twist2D p2pController::update(ros_msgs::Pose2D const& actual_pose)
{   
